...
export default function TheSweetSide() {
  return (
    <section id="sweet" style={{
      minHeight: "100vh",
      width: "100%",
      ...
      <div style={{
        ...
        >
          ...
          <p style={{
            ...
            Crafted for celebrations, cravings, and quiet indulgence.
          </p>
        ...
        >
          <Image 
            src="/sweet-side-display.png" 
            alt="The Sweet Side - Luxury Dessert Assortment" 
            fill 
